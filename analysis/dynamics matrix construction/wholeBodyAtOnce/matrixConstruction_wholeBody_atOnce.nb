...
2b, and total mass is m. ",
 StyleBox["NOTE:",
  FontWeight->"Bold"],
 " Our {X,Y,Z} are mapped to the Diagram\[CloseCurlyQuote]s {X,Y,Z] \
respectively."
}], "Text",
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.701872254859112*^9, 3.701872296330596*^9}, {
  3.701872326699441*^9, 3.701872329723077*^9}, {3.704903610128388*^9, 
  3.704903610288966*^9}}]
}, Open  ]],
...
Cell[BoxData[{
  ...
  RowBox[{"offChestToShoulderL", "=", 
   RowBox[{
    ...
    RowBox[{"OffShoulderLeftFromSpineShoulder1", "*", 
     RowBox[{"BChest", "[", "1", "]"}]}], "+", "\[IndentingNewLine]", 
 ...
 CellChangeTimes->{{3.703823459364182*^9, 3.703823478110409*^9}, {
   ...
   3.703871840230218*^9, 3.7038718410535192`*^9}, {3.70490201132703*^9, 
   3.704902047845292*^9}, {3.704903621552148*^9, 3.7049036236479797`*^9}}]
}, Open  ]],
...
Cell[BoxData[{
 ...
 CellChangeTimes->{{3.701179660648962*^9, 3.701179677596758*^9}, {
   ...
   3.703872079782072*^9, 3.703872085973782*^9}, 3.704902195383461*^9, {
...
Cell[BoxData[{
 RowBox[{
  RowBox[{"offAbToHipL", "=", 
   RowBox[{
    RowBox[{
     RowBox[{"1", "/", "2"}], "*", "BAbdomenHeight", "*", 
     RowBox[{"BAbdomen", "[", "3", "]"}]}], "+", "\[IndentingNewLine]", 
    RowBox[{"OffHipLeftFromSpineMid1", "*", 
     RowBox[{"BAbdomen", "[", "1", "]"}]}], "+", "\[IndentingNewLine]", 
    RowBox[{"OffHipLeftFromSpineMid2", "*", 
     RowBox[{"BAbdomen", "[", "2", "]"}]}], "+", "\[IndentingNewLine]", 
 ...
 CellChangeTimes->{{3.703823191907784*^9, 3.703823365558187*^9}, {
   ...
   3.7038720205895967`*^9, 3.703872031653101*^9}, {3.7049020747246857`*^9, 
   3.7049021519121933`*^9}, {3.704903643951469*^9, 3.704903646063065*^9}}]
}, Open  ]],

Cell[CellGroupData[{

Cell["Neck", "Subchapter",
 CellChangeTimes->{{3.701179877836845*^9, 3.701179882168561*^9}, {
  ...
  RowBox[{"BNeck", ",", "BChest", ",", "Gimbal", ",", "\[IndentingNewLine]", 
   ...
   RowBox[{"BodyToJnt", "\[Rule]", 
    RowBox[{
     ...
     RowBox[{"1", "/", "2"}], "*", 
     RowBox[{"BNeck", "[", "3", "]"}]}]}], ",", 
   RowBox[{"Mass", "\[Rule]", "BNeckMass"}], ",", 
   RowBox[{"Inertia", "\[Rule]", 
    RowBox[{"MoIECylinder", "[", 
     RowBox[{"BNeckMass", ",", 
      RowBox[{"BNeckWidth", "/", "2"}], ",", 
      RowBox[{"BNeckDepth", "/", "2"}], ",", "BNeckHeight", ",", "BNeck"}], 
     "]"}]}]}], "]"}], "\[IndentingNewLine]", 
 RowBox[{"AppFrc", "[", 
  RowBox[{"BNeck", ",", 
   RowBox[{
    RowBox[{"Mass", "[", "BNeck", "]"}], " ", "grav"}], ",", "0"}], 
  "]"}]}], "Input",
 CellChangeTimes->{{3.701179885076363*^9, 3.701179977230372*^9}, {
   3.701180018011428*^9, 3.7011801208251762`*^9}, {3.701185779535787*^9, 
   3.7011858099500237`*^9}, {3.7018714082139378`*^9, 3.7018714172442217`*^9}, 
   3.701872561369685*^9, {3.703823922870009*^9, 3.703823987049531*^9}, {
...
Cell["Head", "Subchapter",
 CellChangeTimes->{{3.703823772225009*^9, 3.703823775384746*^9}}],

Cell["\<\
And the Head, where the Head Height goes all the way to the top of the skull.\
\
\>", "Text",
...
Cell[BoxData[{
 RowBox[{"AddBody", "[", 
  RowBox[{"BHead", ",", "BNeck", ",", "Gimbal", ",", 
   RowBox[{"InbToJnt", "\[Rule]", 
    RowBox[{"BNeckHeight", "*", 
     RowBox[{"1", "/", "2"}], "*", 
     RowBox[{"BNeck", "[", "3", "]"}]}]}], ",", "\[IndentingNewLine]", " ", 
   RowBox[{"BodyToJnt", "\[Rule]", 
    RowBox[{
     RowBox[{"-", "BHeadHeight"}], "*", 
     RowBox[{"1", "/", "2"}], "*", 
     RowBox[{"BHead", "[", "3", "]"}]}]}], ",", 
   RowBox[{"Mass", "\[Rule]", "BHeadMass"}], ",", 
   RowBox[{"Inertia", "\[Rule]", 
    RowBox[{"MoIECylinder", "[", 
     RowBox[{"BHeadMass", ",", 
      RowBox[{"BHeadWidth", "/", "2"}], ",", 
      RowBox[{"BHeadDepth", "/", "2"}], ",", "BHeadHeight", ",", "BHead"}], 
     "]"}]}]}], "]"}], "\[IndentingNewLine]", 
 RowBox[{"AppFrc", "[", 
  RowBox[{"BHead", ",", 
   RowBox[{
    RowBox[{"Mass", "[", "BHead", "]"}], " ", "grav"}], ",", "0"}], 
  "]"}]}], "Input",
 CellChangeTimes->{{3.7011802219380608`*^9, 3.701180279213255*^9}, {
   3.701180436061681*^9, 3.701180516402659*^9}, {3.701180549591803*^9, 
   3.701180561908984*^9}, {3.701185814472028*^9, 3.701185839244787*^9}, {
   3.701871426627925*^9, 3.7018714379314833`*^9}, 3.701872559306159*^9, 
   3.701872680187146*^9, {3.7018727694393187`*^9, 3.701872790524948*^9}, {
   3.7038243088449297`*^9, 3.703824339365099*^9}, {3.70382437143565*^9, 
   3.703824396266677*^9}, {3.703825049783771*^9, 3.7038250661453943`*^9}, {
   3.703856346448709*^9, 3.703856348303652*^9}, 3.7049021953960133`*^9, {
...
Cell[BoxData[{
 RowBox[{"AddBody", "[", 
  RowBox[{"BThighLeft", ",", "BAbdomen", ",", "Gimbal", ",", 
  ...
  RowBox[{"BShinLeft", ",", "BThighLeft", ",", "Hinge", ",", 
   RowBox[{"InbToJnt", "\[Rule]", 
    RowBox[{
     ...
     RowBox[{"BThighLeft", "[", "3", "]"}]}]}], ",", 
   RowBox[{"Axis", "\[Rule]", 
    RowBox[{"BThighLeft", "[", "2", "]"}]}], ",", "\[IndentingNewLine]", 
   RowBox[{"BodyToJnt", "\[Rule]", 
    RowBox[{
     RowBox[{
...
Cell[BoxData[{
 RowBox[{"AddBody", "[", 
  RowBox[{"BFootLeft", ",", "BShinLeft", ",", "Gimbal", ",", 
   RowBox[{"Axis1", "\[Rule]", 
    RowBox[{"BShinLeft", "[", "3", "]"}]}], ",", 
   RowBox[{"Axis2", "\[Rule]", 
    RowBox[{"BShinLeft", "[", "2", "]"}]}], ",", 
 ...
 CellChangeTimes->{{3.701186446027264*^9, 3.7011865033962603`*^9}, {
   ...
   3.704902189772987*^9, {3.7049039522908373`*^9, 3.7049039523947783`*^9}, {
...
Cell[BoxData[{
 RowBox[{"AddBody", "[", 
  RowBox[{"BUArmLeft", ",", "BChest", ",", "Gimbal", ",", 
   RowBox[{"Axis1", "\[Rule]", 
    RowBox[{"-", 
     RowBox[{"BChest", "[", "1", "]"}]}]}], ",", 
   RowBox[{"Axis2", "\[Rule]", 
...
Cell[BoxData[{
 RowBox[{"AddBody", "[", 
  RowBox[{"BHandLeft", ",", "BForeArmLeft", ",", "Gimbal", ",", 
   RowBox[{"InbToJnt", "\[Rule]", 
    RowBox[{
     RowBox[{"BForeArmLeftLength", "/", "2"}], "*", 
     RowBox[{"BForeArmLeft", "[", "3", "]"}]}]}], ",", " ", 
...
Cell[TextData[{
 StyleBox["TODO :",
  FontWeight->"Bold"],
 " add in rest of the printing of TMTXs"
}], "Text",
 CellChangeTimes->{{3.7049022831714153`*^9, 3.704902308506607*^9}}]
}, Open  ]]
}, Open  ]]
},
WindowSize->{955, 855},
