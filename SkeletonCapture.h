...
public:
	...
	void writeToFile(IBodyFrame* bodyFrame);
...
private:
    ...
    // Kinect Sensors
	//IKinectSensorCollection* m_pSensors;
    IKinectSensor*          m_pKinectSensor1;
	IKinectSensor*			m_pKinectSensor2;
    ...
    HRESULT                 InitializeDefaultSensors();
